...
export default {
  ...
  data : () => ({
    team: [
      {name: 'Iyad', role: 'web developer', avatar:'../assets/img/img1.png'},
      {name: 'Reda', role: 'Graphic designer', avatar:'../assets/img/img2.png'},
      {name: 'Zineb', role: 'web developer', avatar:'../assets/img/img3.png'},
      {name: 'Hu TechGroup', role: 'Desktop developer', avatar:'../assets/img/img4.png'}
    ]
  }),
}
</script>
